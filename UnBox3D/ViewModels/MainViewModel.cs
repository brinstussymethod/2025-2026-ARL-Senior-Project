...
namespace UnBox3D.ViewModels
{
    public partial class MainViewModel : ObservableObject
    {
        ...
        // Change these as you like; they’re applied with mesh.SetColor(...)
        private static readonly Vector3 NormalColor = new Vector3(1.0f, 0.0f, 0.0f); // red
        private static readonly Vector3 HighlightColor = new Vector3(0.0f, 0.0f, 1.0f); // blue
        ...
        partial void OnSelectedMeshChanged(IAppMesh value)
        {
            ...
            if (_lastSelectedMesh != null)
                _lastSelectedMesh.SetColor(NormalColor);

            // 2) If we have a new selection, apply the highlight color.
            if (value != null)
                value.SetColor(HighlightColor);
